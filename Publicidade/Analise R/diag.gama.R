...
plot(m,di,xlab="Valor Ajustado", ylab="Distância de Cook",main="Influência 1", ylim=c(0,max(di,2*mean(di))), pch=16)
...
plot(m,ci,xlab="Valor Ajustado", ylab="Distância de Cook Modificada",main="Influência 2", ylim=c(0,max(ci,2*mean(ci))), pch=16)
...
plot(m,dmax,xlab="Valor Ajustado", ylab="dmax",main="Influência 3", ylim=c(0,max(dmax,2*mean(dmax))), pch=16)
